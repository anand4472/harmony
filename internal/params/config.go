...
var (
	...
	EthMainnetShard0ChainID            = big.NewInt(2009)
	EthTestnetShard0ChainID            = big.NewInt(2023)
	EthPangaeaShard0ChainID            = big.NewInt(2021)
	EthPartnerShard0ChainID            = big.NewInt(2020)
	EthStressnetShard0ChainID          = big.NewInt(2024)
	EthTestShard0ChainID               = big.NewInt(2022) // not a real network
	EthAllProtocolChangesShard0ChainID = big.NewInt(2000) // not a real network
)
