...
var (
	...
	EthStressnetShard0ChainID          = big.NewInt(1888000000)
	EthTestShard0ChainID               = big.NewInt(1888100000) // not a real network
	EthAllProtocolChangesShard0ChainID = big.NewInt(1888200000) // not a real network
)
